class WhatToExpectHandler {
    static INITIAL_STATE = {
        questions: [{
            ...
            answer: [
                `A room block is setup under the <a href="http://www.google.com" target="_blank">Lilley-Adamski wedding at the Marriott Springhill Suites Cleveland-Solon</a>.`,
                `All rooms are suites, with WiFi and a buffet breakfast included.`,
                `<a href="http://www.google.com" target="_blank">Register online</a> to be part of our room block discount (approx $109/night).`
            ]
        }, {
            isOpen: false,
